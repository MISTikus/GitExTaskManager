...
namespace GitExtensions.TaskManger
{
    internal class PluginSettings : IEnumerable<ISetting>
    {
        ...
        /// </summary>
        public static StringSetting ExecutablePathProperty { get; }
            = new StringSetting("Executable Path", "Executable path to start by clicking on solution file", null);

        /// <summary>
        /// Gets a property holding arguments for executa ble to start.
        /// </summary>
        public static StringSetting ExecutableArgumentsProperty { get; }
            = new StringSetting("Executable Arguments", $"Optional arguments for executable (with {SolutionFileToken} and {SolutionDirectoryToken} variables)", DefaultExecutableArguments);

        /// <summary>
        /// Gets a property holding arguments for executa ble to start.
        /// </summary>
        public static BoolSetting IsTopLevelSearchedOnlyProperty { get; }
            = new BoolSetting("Top Level Search", "Search only top level directory structure", false);

        /// <summary>
        /// Includes VSCode workspace files (.code-workspace)
        /// </summary>
        public static BoolSetting EnableVSCodeWorkspacesProperty { get; }
            = new BoolSetting("Include VSCode workspaces", "Include VSCode workspace files (.code-workspace)", false);

        /// <summary>
        /// Start executable as Administrator
        /// </summary>
        public static BoolSetting ShouldRunAsAdminProperty { get; }
            = new BoolSetting("Run as Administrator", "Run as Administrator", false);
        ...
        /// </summary>
        public bool IsTopLevelSearchedOnly => source
            .GetBool(IsTopLevelSearchedOnlyProperty.Name, IsTopLevelSearchedOnlyProperty.DefaultValue);


        /// <summary>
        /// Gets current value of <see cref="EnableVSCodeWorkspacesProperty"/>.
        /// </summary>
        public bool EnableVSCodeWorkspaces => source
            .GetBool(EnableVSCodeWorkspacesProperty.Name, EnableVSCodeWorkspacesProperty.DefaultValue);
